...
const terms: TermItem[] = [
  ...
  { id: "notification", label: "서비스 알림 수신 동의", required: true },
...
const TERMS_CONTENT: Record<string, { title: string; sections: { heading?: string; body: string }[] }> = {
  service: {
    ...
    sections: [
      ...
      {
        heading: "제6조 (알림 서비스)",
        body: "① 회사는 회원의 서비스 이용 활동과 관련하여 다음과 같은 알림을 제공합니다.\n• 댓글 알림: 회원이 작성한 게시글에 댓글이 달리거나 다른 회원이 언급(@멘션)한 경우\n• 좋아요 알림: 회원이 작성한 게시글이 좋아요를 받은 경우\n• 족보 복사 알림: 회원이 등록한 족보가 복사된 경우\n• 일정 알림: 회원이 등록한 일정의 3일 전 및 1일 전\n② 알림은 앱 내 알림 및 카카오톡 알림톡을 통해 발송되며, 서비스 이용 활동에 따라 다수의 알림이 발송될 수 있습니다.\n③ 회원은 서비스 내 [마이페이지 > 알림 설정]에서 각 알림 항목의 수신 여부를 변경할 수 있습니다.",
      },
      {
        heading: "제7조 (서비스 이용시간)",
  ...
  notification: {
    ...
    sections: [
      {
        body: "아재요 서비스 이용 중 발생하는 활동 알림을 카카오톡 알림톡 및 앱 내 알림으로 수신하는 것에 동의합니다.",
      },
      {
        heading: "1. 알림 항목 및 발송 조건",
        body: "아래 알림은 회원님의 서비스 이용 활동에 따라 발송됩니다.\n\n• 댓글 알림: 회원님이 작성한 게시글에 댓글이 달리거나, 다른 회원이 회원님을 언급(@멘션)할 경우 발송됩니다.\n• 좋아요 알림: 회원님이 작성한 게시글이 좋아요를 받을 경우 발송됩니다.\n• 족보 복사 알림: 회원님이 등록한 족보가 다른 회원에 의해 복사될 경우 발송됩니다.\n• 일정 알림: 회원님이 등록한 일정의 3일 전(D-3) 및 1일 전(D-1)에 발송됩니다.",
      },
      {
        heading: "2. 알림 수신 채널",
        body: "• 앱 내 알림\n• 카카오톡 알림톡",
      ...
      {
        heading: "3. 다발성 알림 안내",
        body: "서비스 이용 활동에 따라 다수의 알림이 발송될 수 있습니다. 본 동의는 이러한 다발성 알림 수신에 대한 동의를 포함합니다.",
      },
      {
        heading: "4. 수신 설정 변경",
        body: "각 알림 항목은 서비스 내 [마이페이지 > 알림 설정]에서 개별적으로 켜거나 끌 수 있습니다.",
      },
      {
        heading: "유의사항",
        body: "• 본 동의는 서비스 이용에 필요한 필수 동의 항목입니다.\n• 알림 수신 동의 후에도 개별 알림 항목은 알림 설정에서 자유롭게 변경할 수 있습니다.\n• 계정 관련 알림(비밀번호 변경, 서비스 공지 등)은 본 동의와 관계없이 발송됩니다.",
      },
    ],
  },
  marketing: {
