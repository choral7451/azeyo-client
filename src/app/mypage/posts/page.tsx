  ...
  return (
    <main className="pb-6">
      ...
      <div className="flex items-center gap-3 px-5 mb-5 animate-fade-up" style={{ animationDelay: "0.05s" }}>
        ...
        <span className="text-[13px] text-muted-foreground">{myPosts.length}개</span>
      </div>
      ...
      <div className="px-5 space-y-3 animate-fade-up" style={{ animationDelay: "0.1s" }}>
        {myPosts.map((post) => (
          ...
          >
            ...
            {/* Title */}
            <h3 className="text-[14px] font-semibold text-foreground leading-snug mb-1.5">
              {post.title}
            </h3>
                ...
                <div className="space-y-2 mb-3">
                  <div className="rounded-lg overflow-hidden" style={{ backgroundColor: "hsl(35 20% 90%)" }}>
                    <div className="flex items-center justify-between px-3 py-2">
                      <span className={`text-[11px] font-medium ${aWins ? "text-primary font-bold" : "text-muted-foreground"}`}>
                        {post.voteOptionA}
                      </span>
                      <span className={`text-[11px] font-bold ${aWins ? "text-primary" : "text-muted-foreground"}`}>
                        {pctA}%
                      </span>
                    </div>
